...
public class SellingDTO {
	...
	public SellingDTO() {}
	public SellingDTO(int memberCode, int itemCode, String location) {
		super();
		//입력받는 data기반
	...
	public SellingDTO(int sellingCode, int memberCode, int itemCode, int views, String progress, String location) {
		super();
		//Selling 검색시 사용
