			...
			<div class="section section-white section-with-space">
	            <div class="container tim-container">
					...
					<div id="buttons">
	                    ...
	                    <input type="hidden" name="requestCode" value="${requestScope.requestCode}">
	                    <input type="hidden" name="command" value="addRequestApply">
	                    <div class="row">
	                        <div class="col-md-8 col-md-offset-2">
		                        	<div class="form-group">
		                        		<div class="row" style="margin-bottom:20px;margin-top:20px;">
				                        		<div class="col-md-2">
				                        			<h4 style="margin:0px;padding-top:5px;">지원자</h4>
				                        		</div>
				                        		<div class="col-md-10">
			                        ...
			                        <div class="row text-center" style="margin-bottom:20px;">
			                        		<button type="submit" class="btn btn-fill btn-primary">결제</button>
			                        	</div>
			                    	</div>
	                        </div>
	                        </form>
