	                        ...
	                        <div class="col-md-8 col-md-offset-2">
		                        	<div class="form-group">
			                        	<div class="row" style="margin-bottom:20px;">
			                        		...
			                        		<div class="col-md-9">
			                        			<input type="text" value="" placeholder="상품명 또는 요청 제목을 입력하세요" class="form-control">		
			                        		</div>
			                        	</div>
			                        	<div class="row" style="margin-bottom:20px;">
			                        		<div class="col-md-3">
			                        	...
			                        	<div class="row" style="margin-bottom:20px;">
			                        		...
			                        		<div class="col-md-9">
			                        			<input type="text" value="" placeholder="구매 가격을 입력해주세요" class="form-control">
			                        		</div>
			                        	</div>
			                        	<div class="row" style="margin-bottom:20px;">
			                        		<div class="col-md-3">
			                        		...
			                        		<div class="col-md-9">
			                        			<input type="text" value="" placeholder="구매 지역을 입력해주세요" class="form-control">
			                        		</div>
			                        	</div>	
			                        	<div class="row" style="margin-bottom:20px;">
			                        		<div class="col-md-3">
