				...
				<img src="img/profile.png" alt="" style="width:252.5px;height:252.5px;">
					<div class="caption">
						<h3>${item.title}</h3>
							...
							<p>
								<a href='<%=url%>selling?command=sellingDetail&sellingCode=${requestScope.sellingList[status.index].sellingCode}' class="btn btn-primary" role="button" style="margin-left:20px;">${item.price}</a>
